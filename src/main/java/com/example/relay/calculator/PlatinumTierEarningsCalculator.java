...
@Component
public class PlatinumTierEarningsCalculator implements EarningsCalculator{
    Logger LOGGER = Logger.getLogger(PlatinumTierEarningsCalculator.class.getName());
    final static String CARD_TIER = "platinum_tier";
    final static double MINIMUM_EARNING = 15.25;
    final static Map<String,Double> lineItemsRates =
            Map.of("Per successful attempt",0.667,
                    "Per unsuccessful attempt" , 0.155,
                    "Long route bonus" , 12.00);
